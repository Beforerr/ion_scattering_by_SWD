...
Due to the symmetry of ion motion about the $p_z = 0$ line, at the saddle point $z = z_c, p_z = 0$ where two lobes connect at, the potential energy $U$ reaches a local maximum along the $z$-direction, satisfying $∂ U/∂ z = 0$ and $∂^2 U/∂ z^2 < 0$. These conditions allow the expression of the slow variables along the uncertainty curve in the $(κ x, p_x)$ plane as functions of $z_c$. When a particle trajectory crosses the $z = 0$ plane, the crossing point is distributed within a circular region defined by $(p_x - f_1(0))^2 + (\kappa x + f_2(0))^2 = 2H$. The likelihood of the trajectory intersecting the uncertainty curve is therefore proportional to the uncertainty curve length $L_{\text{uc}}$, normalized by the square root of the particle energy $H$.
