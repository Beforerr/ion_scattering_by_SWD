...
let labels = ergs_approx, ax = (xlabel="n", ylabel="M_2(∞) - M_2(n)", xscale=log10, yscale=log10)
...
let labels = ergs_approx, ax = (xlabel="n", ylabel="M_2(n)", xscale=log10, yscale=log10)
    data = res[2:end]
    f = Figure()
    ax = Axis(f[1, 1]; ax...)
    contents = plot_mixing_rate!(data)
